...
| `generation` | `kura clip` cleanup, query expansion, `kura ask` answers, and the `kura triage` / `kura audit` LLM steps (title & tag suggestion, duplicate & link judgment, contradiction check) |
