...
| `llm.models.generation` | string | `"qwen3:4b"` | Used for clip formatting, tag suggestion, query expansion, answer generation, and the contradiction audit (`src/core/clip/format.ts`, `src/core/search/expand.ts`, `src/core/search/ask.ts`, `src/core/audit.ts`). Cache keys include the model. |
